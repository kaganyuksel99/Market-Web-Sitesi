...
<body>
      ...
      <?php 
          ...
          $query = $db->query("select * from kozmetik order by id desc",PDO::FETCH_OBJ);
          
             foreach($query as $row){
             
                 ?>
                 <div class="col-md-4"> 
                 <form action="islem3.php?islem3=ekle&id=<?=$row->id;?>" method="post"> 
        ...
        <?php 
            ...
            if(!empty($_SESSION["sepet"])){
                ...
                foreach($_SESSION["sepet"] as $anahtar => $deger){
                    ...
                    <td><a href="islem3.php?islem3=sil&id=<?=$deger["urun_id"];?>"><span class="text-danger">Kaldır</span></a></td>
                    </tr>
                    <?php
