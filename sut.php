...
<body>
      ...
      <?php 
          ...
          $query = $db->query("select * from sut order by id desc",PDO::FETCH_OBJ);
          
             foreach($query as $row){
             
                 ?>
                 <div class="col-md-4"> 
                 <form action="islem1.php?islem1=ekle&id=<?=$row->id;?>" method="post"> 
        ...
        <?php 
            ...
            if(!empty($_SESSION["sepet"])){
                ...
                foreach($_SESSION["sepet"] as $anahtar => $deger){
                    ...
                    <td><a href="islem1.php?islem1=sil&id=<?=$deger["urun_id"];?>"><span class="text-danger">Kaldır</span></a></td>
                    </tr>
                    <?php
